(function() {
	...
	var exo = (function() {
		...
		var exo = {
			...
			change : function(numExo, nomExo = String(numExo)) {
                            ...
                            document.title = "Exo : " + nomExo.toLowerCase();
        ...
        function hashchange() {
            ...
            var numExo = location.hash.slice(1) || "01",
                nomExo = select.querySelector("option[value='" + numExo + "']").textContent,
                numPrec, numSuiv;

            exo.change(numExo, nomExo);
            select.value = numExo;
